/**
 * Json Map View: toolbar + horizontal resizable columns (scene tree / files | viewport | inspector).
 */
...
export function JsonMapViewPage({ onBackHome }: { onBackHome: () => void }) {
  return (
    <div className="app-shell">
      <JsonMapDuplicateNotice />
      <LayerDataDuplicateNotice />
      <Toolbar onBackHome={onBackHome} />
